...
public class GrepConfigManager{
	public static String mainDir = "plugins" + File.separator + "Grep";
	...
	public void createDefaultSettingsFile(){
		...
		this.database.set("dbname", "databaseName");
		this.database.set("user", "yourUsername");
		this.database.set("pass", "yourPassword");
		save();
	}
}